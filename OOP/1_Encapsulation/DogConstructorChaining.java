class Dog {
    ...
    public Dog(String breed, float age, int price) {  // Three Arguments Constructor
        this(breed); // Calls the one argument constructor to set defaults and the breed.
        this.age = age;
        this.price = price;
    }

    public Dog(String breed){ // One Argument Constructor
        this(); // Calls the zero argument constructor to set age and price defaults.
        this.breed = breed;
    }
...
public class DogConstructorChaining { 
